...
public class PasswordValidator {
     ...
     * @param password sting ที่ต้องการตรวจสอบ
     * @return ส่งกลับความยากของรหัสหรือความถูกต้อง(Invaild)
     * @throw IllegalArgumentExeption ถ้ารหัสผ่านมีค่า null หรือ empty
     */
